...
function tabulate(data, columns, div) {
  ...
  table.selectAll('td').on('mouseover', mouseover).on('mouseleave', mouseleave);
...
function recolor(x) {
  ...
  var restaurants = [
    ...
    'Saiguette',
    "Bob's Your Uncle",
    'Duke Ellington Gourmet Deli',
    'Pie Pie Pizza',
    "Joe's Deli",
    'Mekong',
    'Empire Garden',
    "Benny's Chao King",
    'King Columbus Gourmet Deli',
    'JuicC',
    "Panini D'Parma",
    "Haakon's Hall",
    ...
    'Saga Sushi',
    'Oaxaca Taqueria',
    'La Salle Deli and Ice Cream',
    'Columbia University Deli &amp; Grocery',
    'Toast',
    'Nacho Tacos',
    ...
    'Subway',
    'BTH',
    'Columbia Deli Market',
    'Tamarind Gourmet',
    "Tom's Delicious Pizza",
    "Patrick Ryan's",
    "Panda's Chinese Restaurant",
    'Stop Restaurant &amp; Lounge',
    'China Place ',
    'China Place and Hana',
    "Ollie's",
    'Vine Sushi &amp; Sake',
    'Uni Cafe',
    'M2M',
    ...
    'Biryani Spot &amp; Curry',
    'Chandni Restaurant',
    'Blue Mountain Deli Mini Market',
    'Manhattan Brew &amp; Vine',
    '994 Columbus Deli',
    'Isola',
    "Zanny's Cafe",
    ...
    'Columbus Restaurant',
    'Capri Restaurant',
    'Elsa Cafe Restaurant',
    'Kennedy Fried Chicken Food Outlet',
    'Roasted Masala',
    'Parkside Gourmet',
    'Lime Leaf',
    'Krik Krak',
  ...
  for (var i = 0; i < trs.length; i++) {
    ...
    for (var h = 0; h < tds.length; h++) {
      ...
      if (
        dict[tds[h].innerHTML] != 'nyc chain' &&
        dict[tds[h].innerHTML] != 'non-chain' &&
        dict[tds[h].innerHTML] != 'chain' &&
        tds[h].title != 'none'
      ) {
